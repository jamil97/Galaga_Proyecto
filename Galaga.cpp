               ...
               //Valida que haga disparos
                ...
                /* for (int j = 0; j < enemigos.size(); j++) {
                    if (i==enemigos[j]->getX()) {
                      attron(COLOR_PAIR(2));
                      move(enemigos[j]->getX(),enemigos[j]->getY()-1);
                      printw(" ");
                      move (enemigos[j]->getX(),enemigos[j]->getY());
                      printw(" ");
                      attron(COLOR_PAIR(2));
                      move(enemigos[j]->getX(),enemigos[j]->getY()+1);
                      printw(" ");
                      attron(COLOR_PAIR(2));
                      move(enemigos[j]->getX(),enemigos[j]->getY()+2);
                      printw(" ");
                      attron(COLOR_PAIR(2));
                      move(enemigos[j]->getX(),enemigos[j]->getY()+3);
                      printw(" ");
                      attron(COLOR_PAIR(2));
                      move(enemigos[j]->getX(),enemigos[j]->getY()+4);
                      printw(" ");
                      move(enemigos[j]->getX(),enemigos[j]->getY()+5);
                      printw(" ");

                      //Cuerpo Bajo
                      move(enemigos[j]->getX()-1,enemigos[j]->getY());
                      printw(" ");
                      move(enemigos[j]->getX()-1,enemigos[j]->getY()+1);
                      printw(" ");
                      move(enemigos[j]->getX()-1,enemigos[j]->getY()+2);
                      printw(" ");
                      move(enemigos[j]->getX()-1,enemigos[j]->getY()+3);
                      printw(" ");
                      attron(COLOR_PAIR(2));
                      move(enemigos[j]->getX()-1,enemigos[j]->getY()+4);
                      printw(" ");
                    }
                }*/
            }
